...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/tmp/build-env-jjr58lsi/bin/python",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/project/.mesonpy-dzmelmzi/lib/contourpy/util",
        source_dir=r"/project/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/project/.mesonpy-dzmelmzi/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
